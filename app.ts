//==================================Q2=====================================
//Question...Personal Message: Store a person’s name in a variable, and print a message to that person. 
...
// Question...Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, 
...
//=================================Q5======================================
// Question...Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name in a variable called 
...
//==================================Q6======================================
// Question...Stripping Names: Store a person’s name, and include some whitespace characters at the beginning and end 
...
// Question...Favorite Number: Store your favorite number in a variable. Then, using that variable, create a message 
...
// let myFavFruits = ['apple','mango','orange'];
...
//1st or 2nd. Most ordinal numbers end in the, except 1, 2, and 3.
...
// function cities(city : string , countries = "Pakistan"){
//        console.log(`The city ${city} is in ${countries}.`);
//    }
//    cities ('Karachi');
//    cities ('Lahore');
//    cities('Makkah' , 'Arab');
...
// function createCar(manufacturer: string, model: string, ...extras: [string, any][]){
//     let car: any = {
...
//     return car;
// }
// let myCar: any = createCar("Toyota", "Camry", ["color", "red"], ["year", 2022]);
// console.log(myCar);
